...
class DeepSort(object):
    ...
    """
    Update tracks based when measurements have arrived.
    ...
    ori_img : ndarray
        The original image for this measurement.

    Returns
    -------
    squared_maha : ndarray
        Returns an array of the number of confirmed and most recently 
        updated tracks, where the i-th element contains the 
    ...
    def update(self, bbox_xywh, confidences, ori_img):
        ...
        bbox_tlwh = self._xywh_to_tlwh(bbox_xywh) # (xc, yc, w, h) -> (x1, y1, w, h)
        ...
        for track in self.tracker.tracks:
            ...
            box = track.to_tlwh() # (xc, yc, a, h) -> (x1, y1, w, h)
            x1, y1, x2, y2 = self._tlwh_to_xyxy(box) # (xc, yc, a, h) -> (x1, y1, x2, y2)
