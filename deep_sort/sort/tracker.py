...
class Tracker:
    """
    This is the multi-object tracker.
    ...
    max_iou_distance : float
        Threshold value for cost matrix in IOU matching.
    max_age : int
    ...
    def _initiate_track(self, detection):
        """
        Initialize the trajectory state and infomation.
        """
